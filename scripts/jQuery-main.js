...
imgs.forEach(function (element) {
    ...
    // jQuery allows us to form the link element with the prescribed attributes. The link is created to hold metadata and to show the user it is interactive
    var $navElement = $('<a>', {
        'alt': element.name,
        'href': element.src,
        'class': 'nav-item',
